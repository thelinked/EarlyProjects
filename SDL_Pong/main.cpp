...
//-----------------------------
const int DONT_SHOW_MENU = -2;
const int SHOW_MENU = -1;
const int NEW_GAME = 0;
const int SET_BINDINGS = 1;
const int OPTIONS = 2;
const int QUIT = 3;
//-----------------------------
...
{
    //Set up the screen
    Display = SDL_SetVideoMode( SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_BPP, SDL_HWSURFACE | SDL_RESIZABLE | SDL_DOUBLEBUF );
...
void Window::handle_event( SDL_Event event )
{
    ...
    if( event.type == SDL_VIDEORESIZE )
    {
        ...
        //Resize the screen
        Display = SDL_SetVideoMode( event.resize.w, event.resize.h, SCREEN_BPP, SDL_HWSURFACE | SDL_RESIZABLE | SDL_DOUBLEBUF );
...
void Window::toggle_fullscreen()
{
    ...
    if( windowed == true )
    {
        ...
        Display = SDL_SetVideoMode( SCREEN_WIDTH_FULL, SCREEN_HEIGHT_FULL, SCREEN_BPP, SDL_HWSURFACE | SDL_RESIZABLE | SDL_FULLSCREEN | SDL_DOUBLEBUF );
